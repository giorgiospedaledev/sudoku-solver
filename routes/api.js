...
module.exports = function (app) {
  ...
  app.route('/api/check')
    .post((req, res) => {
      ...
      const column = Number.parseInt(coordinate.match(/\d+/g)[0]) - 1;
      ...
      const canPlaceInRow = solver.checkRowPlacement(puzzle, row, column, value);
      const canPlaceInColumn = solver.checkColPlacement(puzzle, row, column, value);
      const canPlaceInRegion = solver.checkRegionPlacement(puzzle, row, column, value);
